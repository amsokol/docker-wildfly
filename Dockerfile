...
ENTRYPOINT ["java", "-D[Standalone]", "-server", "-Xms64m", "-Xmx512m", "-XX:MaxPermSize=256m", "-Djava.net.preferIPv4Stack=true", "-Djboss.modules.system.pkgs=org.jboss.byteman", "-Djava.awt.headless=true", "-Dorg.jboss.boot.log.file=/opt/jboss/wildfly/standalone/log/server.log", "-Dlogging.configuration=file:/opt/jboss/wildfly/standalone/configuration/logging.properties", "-jar", "/opt/jboss/wildfly/jboss-modules.jar", "-mp", "/opt/jboss/wildfly/modules", "org.jboss.as.standalone", "-Djboss.home.dir=/opt/jboss/wildfly", "-Djboss.server.base.dir=/opt/jboss/wildfly/standalone"]
